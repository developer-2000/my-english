...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
          ...
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              if (_this.checkSuccess(response)) {
                _this.initialData();
                jquery__WEBPACK_IMPORTED_MODULE_8___default()('#create_word').modal('hide');
                jquery__WEBPACK_IMPORTED_MODULE_8___default()('.modal-backdrop.fade.show').remove();
              }
              _context.next = 10;
              break;
            case 7:
          ...
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              if (_this2.checkSuccess(response)) {
                _this2.initialData();
                jquery__WEBPACK_IMPORTED_MODULE_8___default()('#update_word').modal('hide');
                jquery__WEBPACK_IMPORTED_MODULE_8___default()('.modal-backdrop.fade.show').remove();
              }
              _context2.next = 10;
              break;
    ...
    updateColumnTable: function updateColumnTable() {
      ...
      var timerId = setTimeout(function () {
        ...
        document.querySelectorAll("#vgt-table .btn_block_column").forEach(function (tag) {
          prev = jquery__WEBPACK_IMPORTED_MODULE_8___default()(tag).prev();
          // нет слова в столбце
          if (prev.text() == '') {
            jquery__WEBPACK_IMPORTED_MODULE_8___default()(tag).parent().css('display', 'none');
          }
          // преобразовать слово в столбце
            ...
            jquery__WEBPACK_IMPORTED_MODULE_8___default()(tag).parent().css('display', 'flex');
          }
        });
      }, 500);
    },
    ...
    hoverWordShowTitle: function hoverWordShowTitle() {
      var _this8 = this;
      jquery__WEBPACK_IMPORTED_MODULE_8___default()('body').on('mouseover', '.trigger', function (event) {
    ...
    outputHelperAlertInTable: function outputHelperAlertInTable(event) {
      ...
      var row = this.getRowForWord(jquery__WEBPACK_IMPORTED_MODULE_8___default()(event.target).text());
      if (row == null) {
        return false;
      }
      ...
      var instance = jquery__WEBPACK_IMPORTED_MODULE_8___default()(event.target)[0]._tippy;
    ...
    setStyleDataModal: function setStyleDataModal(type) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_8___default()('.desc_type').css('border-color', type.color);
      jquery__WEBPACK_IMPORTED_MODULE_8___default()('.desc_type .text').html(string);
    },
    ...
    initialClickButWordUpdate: function initialClickButWordUpdate() {
      ...
      var a = setTimeout(function () {
        // удалить
        jquery__WEBPACK_IMPORTED_MODULE_8___default()('.btn-danger.delete').bind('click', function (e) {
          var queryObj = jquery__WEBPACK_IMPORTED_MODULE_8___default()(e.target).prop("tagName") !== "A" ? jquery__WEBPACK_IMPORTED_MODULE_8___default()(e.target).parent() : jquery__WEBPACK_IMPORTED_MODULE_8___default()(e.target);
        ...
        // редактировать
        jquery__WEBPACK_IMPORTED_MODULE_8___default()('.btn-warning.edit').bind('click', function (e) {
          var queryObj = jquery__WEBPACK_IMPORTED_MODULE_8___default()(e.target).prop("tagName") !== "A" ? jquery__WEBPACK_IMPORTED_MODULE_8___default()(e.target).parent() : jquery__WEBPACK_IMPORTED_MODULE_8___default()(e.target);
          var word = queryObj.parent().prev(".trigger").text();
    ...
    openModalCreateWord: function openModalCreateWord() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_8___default()('#create_word').modal('show');
      jquery__WEBPACK_IMPORTED_MODULE_8___default()('#create_word').on('shown.bs.modal', function () {
    ...
    openUpdateWordModal: function openUpdateWordModal(word) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_8___default()('#update_word').modal('show');
    },
    // Закрыть любую модалку
    closeAllModals: function closeAllModals() {
      var _this12 = this;
      jquery__WEBPACK_IMPORTED_MODULE_8___default()(".modal").on("hidden.bs.modal", function () {
    ...
    openLearnModal: function openLearnModal() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_8___default()('#learn_word').on('hidden.bs.modal', function () {
    ...
    initialiseToggle: function initialiseToggle() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_8___default()(this.$refs.toggle1).change(this.logToggleState);
      jquery__WEBPACK_IMPORTED_MODULE_8___default()(this.$refs.toggle2).change(this.logToggleState);
    },
    // при изменении toggle
    logToggleState: function logToggleState(event) {
      this.objGenerateSentences.status_toggle = jquery__WEBPACK_IMPORTED_MODULE_8___default()(event.target).prop('checked');
    ...
    clearGenerateSentences: function clearGenerateSentences() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_8___default()(this.$refs.toggle1).prop('checked', false).change();
      jquery__WEBPACK_IMPORTED_MODULE_8___default()(this.$refs.toggle2).prop('checked', false).change();
    }
  },
  ...
  beforeDestroy: function beforeDestroy() {
    jquery__WEBPACK_IMPORTED_MODULE_8___default()('.btn-warning').unbind('click');
    jquery__WEBPACK_IMPORTED_MODULE_8___default()('.btn-danger').unbind('click');

    // Удаляем инициализацию перед уничтожением компонента
    jquery__WEBPACK_IMPORTED_MODULE_8___default()(this.$refs.toggle1).bootstrapToggle('destroy');
    jquery__WEBPACK_IMPORTED_MODULE_8___default()(this.$refs.toggle2).bootstrapToggle('destroy');
  },
  validations: {
    arrInputsModal: {
      new_word: {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "modal-title"
  }, [_vm._v("Loading generate sentences")]), _vm._v(" "), _c("button", {
  ...
  }, [_vm._v("No Sentence")])])])])]), _vm._v(" "), _c("div", {
