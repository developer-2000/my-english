            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <template v-if="objLearnWord !== null">
                        ...
                        <div
                            v-if="
                                objLearnWord.sentences.length > 0 || objLearnWord.url_image !== null
                            "
                            class="box-helper"
                        >
                            <!-- изображение слова -->
                            <img
                                v-if="objLearnWord.url_image !== null"
                                :src="objLearnWord.url_image"
                                alt="Image"
                            />
                            <!-- предложения -->
                            <div v-if="objLearnWord.sentences.length > 0" class="box-sentences">
                                <div
                                    v-for="(sentence, key) in objLearnWord.sentences"
                                    :key="key"
                                    class="sentence"
                                    v-text="
                                        objLanguage.languageIndex === 0
                                            ? sentence.sentence
                        ...
                        <div class="form-group box-write-word">
                            ...
                            <svg
                                v-show="objOldLearnWord.word === write_word"
                                class="svg-like"
...
<script>
    ...
    export default {
        ...
        mixins: [help_search_word_mixin, response_methods_mixin, translation_i18n_mixin],
        data() {
            return {
                objLanguage: {
                    languageIndex: 0,
        ...
        methods: {
            ...
            viewLanguageLine() {
                const result =
                    this.objLanguage.languageIndex === 0
...
${this.objLearnWord.description == null ? '' : this.objLearnWord.description.toLowerCase()}
                ...
                const instance = $(event.target)[0]._tippy;
