        ...
        <div class="modal-dialog modal-dialog-centered custom-modal" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Изучать предложения</h5>
                    <div class="box-right">
                        <!-- переключатель языка -->
                        <div
                ...
                <div class="modal-body">
                    ...
                    <template v-else>
                        ...
                        <div class="box-word">
                            <!-- слово -->
                            <div class="learn-word-trigger" v-text="currentSentence.sentence"></div>
                            <!-- кнопки -->
...
<script>
    ...
    export default {
        ...
        mixins: [response_methods_mixin, translation_i18n_mixin],
        data() {
            return {
                know: 0,
                not_know: 0,
            ...
            async loadLearnSentence(action = null) {
                ...
                try {
                    ...
                    const response = await this.$http.post(
                        `${this.$http.webUrl()}sentence/learn/get-sentence`,
                        data
                    );
