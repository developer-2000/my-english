...
<head>
    ...
    @else
        @php
            $cssFiles = \App\Helpers\ViteHelper::css('resources/sass/app.scss');
        @endphp
...
@else
    <script type="module" src="{{ asset('build/vendor-BWvGGqL6.js') }}"></script>
    <script type="module" src="{{ asset('build/app-DNKL6LBO.js') }}"></script>
@endif
